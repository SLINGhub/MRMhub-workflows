...
- Two notebooks differ only in scale/dataset: `Dataset1.qmd` (Supplementary Code 1 — 503 features × 937 samples, Tan et al.) and `Dataset3.qmd` (Supplementary Code 2 — 829 features × 4,591 samples, Chen et al.). Keep them parallel in structure; a change demonstrated in one usually belongs in the other.
